...
public class Parameter {
	...
	private Integer parametersubId;
	
	private String paraDiscribe;
	...
	public Integer getParametersubId() {
		return parametersubId;
	}

	public void setParametersubId(Integer parametersubId) {
		this.parametersubId = parametersubId;
	}

	public String getParaDiscribe() {
		return paraDiscribe;
	}

	public void setParaDiscribe(String paraDiscribe) {
		this.paraDiscribe = paraDiscribe;
	}
