...
public class OperationChuKuActivity extends Activity {
...
//	private TextView tvupload, tvdel, tvnext, tvopen, tvexport;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chukuoperation);
		...
		ruKuDao=new RuKuDao(OperationChuKuActivity.this);
	...
	private void init() {
		...
		tvnexttotal.setOnClickListener(new OnClickListener(){
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(OperationChuKuActivity.this,
...
//					Common.deviceid = android.os.Build.MANUFACTURER;//制造厂商
	...
	public void showDialog(String title) {
		 ...
		 new AlertDialog.Builder(OperationChuKuActivity.this).setTitle("数据删除")//设置对话框标题
