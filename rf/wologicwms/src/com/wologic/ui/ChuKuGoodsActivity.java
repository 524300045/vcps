...
import com.wologic.ui.RuKuGoodsActivity.MyAdapter;
import com.wologic.ui.RuKuGoodsActivity.ViewHolder;
...
public class ChuKuGoodsActivity extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chukugoods);
		...
		ruKuDao = new RuKuDao(ChuKuGoodsActivity.this);
	...
	private void initEvents() {
					...
					case KeyEvent.ACTION_UP:
						...
						if (barCodeList == null || barCodeList.size() == 0) {
							...
							mediaPlayer = MediaPlayer.create(
									ChuKuGoodsActivity.this, R.raw.error);
						...
						if (itemDataList.size() == 1) {
							...
							productNo = itemDataList.get(0).getProductno();// 获取商品好
							...
							else
							{
								try {
								   ...
								   Double num=d+itemDataList.get(0).getPkgrate();
		...
		btnSure.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				 ...
				 * itemDataDao.GetItemDataByBarCode( itemNo, code); if
				 * (itemDataList == null || itemDataList.size() == 0) {
				 * tvMsg.setVisibility(View.VISIBLE);
				 * tvMsg.setText("查询不到当前商品!"); return;// 查询不到商品 }
				 */
...
//						Double.parseDouble(num));
		...
		imgfind.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(ChuKuGoodsActivity.this,
		...
		imgscan.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				intent.setClass(ChuKuGoodsActivity.this, MipcaActivityCapture.class);
	...
	// 弹窗,获取当前产品的数量
		private void dialog(final String productNo,String num,String ProductName) {
			final CustomDialog dialog = new CustomDialog(ChuKuGoodsActivity.this);
			...
			dialog.setOnPositiveListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (editText.getText().equals("")) {
						...
						mediaPlayer = MediaPlayer.create(ChuKuGoodsActivity.this,
								R.raw.error);
						mediaPlayer.setVolume(1.0f, 1.0f);
						mediaPlayer.start();
						return;
...
//	        colorPos = position%3;
	...
	public void showDialog2(String title,final String productNo){
		new AlertDialog.Builder(ChuKuGoodsActivity.this)
		.setTitle("删除产品")
		//设置对话框的标题
		.setMessage(title)
		//设置显示的信息
	...
	public void showDialog(List<ItemData> list) {
		...
		builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if (productNo.equals("")) {
					Toast.makeText(ChuKuGoodsActivity.this, "还未选择商品", 2000)
							.show();
	...
	// 弹窗
		private void dialog() {
			CustomDialog	dialog = new CustomDialog(ChuKuGoodsActivity.this);
